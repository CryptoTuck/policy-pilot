...
export async function POST(request: NextRequest) {
  try {
    ...
    // Parse the incoming Canopy Connect data
    ...
    // Grade the policy using OpenAI (pass raw text directly)
...
export async function GET() {
  return NextResponse.json({ status: 'Canopy webhook endpoint active' });
}
